...
export default function notify(message, icon){
  ...
  notification.className = 'fixed bottom-4 right-4 bg-card border border-input text-foreground px-6 py-3 rounded-lg shadow-sm transform transition-all duration-300 translate-y-0 z-50 flex items-center gap-2'
